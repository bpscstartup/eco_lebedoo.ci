		...
		<div class="row">
			...
			<div class="col-sm-4">
				...
				if( $type == 2 ){
                    ...
                    $gm_offset_string = $gmt_offset > 0 ? '+'.$gmt_offset : ($gmt_offset < 0 ? $gmt_offset : '');
					if( !empty( $expire ) ){
						?>
							...
							<div class="white-block-content">
								<div class="flex-wrap flex-start-h">
									...
									<div class="flex-right">
                                        ...
                                        <h5 class="countdown" data-expire="<?php echo esc_attr( $expire - $gmt_offset * 3600 ) ?>">
                                            <span class="cd-days">0</span>
                                            <span class="cd-days-text"><?php esc_html_e( 'Days', 'adifier' ) ?></span>
                                            <span class="cd-hours">00</span>:<span class="cd-mins">00</span>:<span class="cd-secs">00</span>
                                        </h5>                                        
										<p><?php printf( esc_html__( 'Ends on %s (UTC%s)', 'adifier' ), date_i18n( get_option( 'date_format' ) .' '. get_option( 'time_format' ), $expire ), $gm_offset_string ); ?></p>
									</div>
								</div>
							</div>
						</div>
