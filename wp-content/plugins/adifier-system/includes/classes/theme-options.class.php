            ...
            $this->_sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'card_width',
                        'type'      => 'text',
                        'title'     => esc_html__('Adifier Card -  Width', 'adifier') ,
                        'desc'      => esc_html__('Width for images in list layout - number only', 'adifier'),
                        'default'   => '355'
                    ),
                    array(
                        'id'        => 'card_height',
                        'type'      => 'text',
                        'title'     => esc_html__('Adifier Card -  Height', 'adifier') ,
                        'desc'      => esc_html__('Height for images in list layout - number only', 'adifier'),
                        'default'   => '400'
                    ),
                    array(
                        ...
                        'title'     => esc_html__('Adifier Card -  Crop', 'adifier') ,
                        'desc'      => esc_html__('Whether to crop images to specified width and height or resize', 'adifier'),
                        'default'   => true
                    ),
                    array(
                ...
                'fields'    => array(                   
                    ...
                    array(
                        ...
                        'options'   => array(
                            ...
                            'tax_id'        => esc_html__( 'Tax ID', 'adifier' ),
                    ...
                    array(
                        'id'        => 'enable_tax_id',
                        'title'     => esc_html__( 'Enable Tax ID', 'adifier' ),
                        'type'      => 'select',
                        'options'   => array(
                            'yes'       => esc_html__( 'Yes', 'adifier' ),
                            'no'        => esc_html__( 'No', 'adifier' ),
                        ),
                        'desc'      => esc_html__('Enable or disable Tax ID field', 'adifier'),
                        'default'   => 'no'
                    ),              
                    array(
                        'id'        => 'bidding_step',
            ...
            $this->_sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'title'     => esc_html__( 'Min Description Length', 'adifier' ),
                        'type'      => 'text',
                        'desc'      => esc_html__('Input minimum number of chars that description must have', 'adifier'),
                    ),
                    array(
                        'id'        => 'update_slug',
                        'title'     => esc_html__( 'Update Slug On Title Change', 'adifier' ),
                        'type'      => 'checkbox',
                        'desc'      => esc_html__('If this option is checked then slug of the advert will be changed if the title is changed', 'adifier'),
                    ),
                    array(
                        'id'        => 'currencies',
