<div class="white-block hover-shadow advert-item advert-list <?php echo esc_attr( !adifier_has_image() ? 'item-no-image' : '' ) ?> <?php echo adifier_is_highlighted() ? esc_attr( 'advert-hightlight' ) : esc_attr( '' ) ?>">

	<?php include( get_theme_file_path( 'includes/advert-boxes/ribbons.php' ) ) ?>

	<div class="flex-wrap flex-start-h">
        <?php if( adifier_has_image() ): ?>
            <div class="flex-left">            
