...
class Adifier_Stripe{
        ...
        $sections[] = array(
            ...
            'fields'    => array(
                ...
                array(
                    'id'        => 'pk_client_id',
                    'type'      => 'text',
                    'title'     => esc_html__('Publishable key', 'adifier') ,
                    'desc'      => esc_html__('Input your stripe public API key', 'adifier'),
                ),
                array(
                    'id'        => 'sk_client_id',
                    'type'      => 'text',
                    'title'     => esc_html__('Secret key', 'adifier') ,
                    'desc'      => esc_html__('Input your stripe secret API ID', 'adifier'),
				),
            )
        );
	...
	*/
	static public function render(){
		?>	
		<li>
			<a href="javascript:void(0);" id="stripe-button" data-returnmessage="<?php esc_attr_e( 'Your payment is being processed and once it is approved you will receive purchased goods', 'adifier' ) ?>">
