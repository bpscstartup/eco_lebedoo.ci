...
class Adifier_Fondy{
	...
	*/
	static public function render(){
		?>	
		<li>
			<a href="javascript:void(0);" id="fondy-button" data-returnmessage="<?php esc_attr_e( 'Your payment is being processed and once it is approved you will receive purchased goods', 'adifier' ) ?>">
