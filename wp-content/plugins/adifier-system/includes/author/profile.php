...
$author_meta = array(
    ...
    'tax_id'		=> get_user_meta( $author->ID, 'tax_id', true ),
				...
				<div class="white-block-content">
					<form class="ajax-form">
						...
						<div class="row">
                            ...
                            <?php if( adifier_get_option( 'enable_tax_id' ) == 'yes' ): ?>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="tax_id"><?php !empty( $mandatory_fields['tax_id'] ) ? esc_html_e( 'Tax ID *', 'adifier' ) : esc_html_e( 'Tax ID', 'adifier' ) ?></label>
                                        <input type="text" name="tax_id" id="tax_id" value="<?php echo esc_attr( $tax_id ); ?>" placeholder="<?php esc_attr_e( 'Your Tax ID for the invoice', 'adifier' ); ?>">
                                    </div>
                                </div>
                            <?php endif; ?>
						</div>
