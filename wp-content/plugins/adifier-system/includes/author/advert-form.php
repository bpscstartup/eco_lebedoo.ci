		...
		<form class="ajax-save-advert" autocomplete="off">
			...
			<div class="row">
				<div class="col-sm-7">
					<?php if( $type == '2' ): ?>
						<?php
						$data = adifier_print_bidding_history( $id, 1, adifier_is_expired( $id ) ? true : false );
					...
					<div class="white-block white-block-extra-padding">
						...
						<div class="white-block-content">
							...
							<div class="form-group no-margin">
                                <?php $min_description_length = adifier_get_option( 'min_description_length' ) ?>
								<label for="description" class="label-bottom-margin">
                                    <?php if( !empty( $min_description_length ) ): ?>
                                        <?php printf( esc_html__( 'Description (min %s chars) *', 'adifier' ), $min_description_length ); ?>
                                    <?php else: ?>
