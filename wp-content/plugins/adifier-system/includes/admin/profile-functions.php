...
function adifier_add_user_meta( $user ){
    ?>
		...
		$author_meta = array(
            ...
            'af_unlimited'	=> get_user_meta( $user->ID, 'af_unlimited', true ),
		);
        ...
        <table class="form-table">
            ...
            <tr>
                <th>
                	<label for="tax_id"><?php esc_html_e( 'Tax ID', 'adifier' ); ?></label>
                </th>
                <td>
                    <input type="text" class="regular-text" value="<?php echo esc_attr( $tax_id ) ?>" name="tax_id" />
                </td>
            </tr>
            <tr>
                <th>
            ...
            <tr>
                <th>
                    <label for="af_unlimited"><?php esc_html_e( 'Unlimited Submit', 'adifier' ); ?></label>
                </th>
                <td>
                    <input type="checkbox" name="af_unlimited" value="1" <?php checked( $af_unlimited, 1 ); ?>>
                </td>
            </tr>
            <tr>
                <th>
...
function adifier_save_user_meta( $user_id ){
    update_user_meta( $user_id, 'af_unlimited', sanitize_text_field( $_POST['af_unlimited'] ) );
